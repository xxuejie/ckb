...
use crate::syscalls::{
    ...
    SPAWN_EXTRA_CYCLES_BASE, SUCCESS, WAIT_FAILURE, INDEX_OUT_OF_BOUND,
};
        ...
        for message in messages {
            match message {
                Message::ExecV2(vm_id, args) => {
                    ...
                    let (program, _full_length) = {
                        ...
                        match sc.load_data(
                            ...
                            Err(Error::SnapshotDataLoadError) => {
                                ...
                                old_machine.machine.set_register(A0, INDEX_OUT_OF_BOUND as u64);
                                continue;
                            }
                            Err(e) => return Err(e),
                        }
                    ...
                    // if args.location.offset >= full_length {
                    //     machine.set_register(A0, Mac::REG::from_u8(SLICE_OUT_OF_BOUND));
                    //     return Ok(false);
                    // }
                    // This will not happen as well
